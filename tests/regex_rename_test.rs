...
use openlist_tui::app::{App, RegexFocus, Screen};
...
fn test_generate_regex_preview_basic() {
    ...
    assert_eq!(
        app.rename.regex.preview[0],
        ("Episode.01.mkv".to_string(), "Show.S01E01.mkv".to_string())
    );
    assert_eq!(
        app.rename.regex.preview[1],
        ("Episode.02.mkv".to_string(), "Show.S01E02.mkv".to_string())
    );
    assert_eq!(
        app.rename.regex.preview[2],
        ("Episode.03.mkv".to_string(), "Show.S01E03.mkv".to_string())
    );
}
...
fn test_generate_regex_preview_capture_groups() {
    ...
    app.navigation.files = vec![
        FileItem {
            name: "MyShow.S01E01.1080p.mkv".to_string(),
            is_dir: false,
            size: Some(1000),
        },
        FileItem {
            name: "MyShow.S01E02.1080p.mkv".to_string(),
            is_dir: false,
            size: Some(1000),
        },
    ];
...
fn test_execute_regex_rename() {
    ...
    app.navigation.files = vec![
        FileItem {
            name: "old_01.mkv".to_string(),
            is_dir: false,
            size: Some(1000),
        },
        FileItem {
            name: "old_02.mkv".to_string(),
            is_dir: false,
            size: Some(1000),
        },
        FileItem {
            name: "old_03.mkv".to_string(),
            is_dir: false,
            size: Some(1000),
        },
    ];
    ...
    assert_eq!(
        results[0],
        ("old_01.mkv".to_string(), "new_01.mkv".to_string(), true)
    );
    assert_eq!(
        results[1],
        ("old_02.mkv".to_string(), "new_02.mkv".to_string(), true)
    );
    assert_eq!(
        results[2],
        ("old_03.mkv".to_string(), "new_03.mkv".to_string(), true)
    );
...
fn test_regex_simple_find_replace() {
    ...
    app.navigation.files = vec![
        FileItem {
            name: "test_file_1.mkv".to_string(),
            is_dir: false,
            size: Some(1000),
        },
        FileItem {
            name: "test_file_2.mkv".to_string(),
            is_dir: false,
            size: Some(1000),
        },
    ];
    ...
    assert_eq!(
        app.rename.regex.preview[0],
        ("test_file_1.mkv".to_string(), "prod_file_1.mkv".to_string())
    );
    assert_eq!(
        app.rename.regex.preview[1],
        ("test_file_2.mkv".to_string(), "prod_file_2.mkv".to_string())
    );
}
...
fn test_regex_remove_extension_pattern() {
    ...
    app.navigation.files = vec![FileItem {
        name: "Video.2023.1080p.mp4".to_string(),
        is_dir: false,
        size: Some(1000),
    }];
    ...
    assert_eq!(
        app.rename.regex.preview[0],
        ("Video.2023.1080p.mp4".to_string(), "Video.mp4".to_string())
    );
}
...
fn test_regex_multiple_capture_groups() {
    let mut app = App::new();
    app.navigation.files = vec![FileItem {
        name: "Series.S02E15.720p.HDTV.mkv".to_string(),
        is_dir: false,
        size: Some(1000),
    }];
